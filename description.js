...
$(function() {
  $("li").on("click",function() {
	  if(this.id=="dnt") {
		  $("#dnt_txt").html("Você pode doar via PayPal: marcelofabiano"+"@"+"icloud.com");
	  }
  });
});
function loadPackageInfo() {
	...
	$.ajax({
		...
		error: function (err) {
			$("#errorInfo").html("Não há descrição para "+urlSelfParts[1]);
		}
	});
}
